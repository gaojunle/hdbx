...
const _includeDir = /(src|hdbx_share)/;
...
var config = {
    ...
    resolve: {
         ...
         * @date 2018-07-31
         */
        extensions: [".js", ".json", ".jsx", ".scss", ".less", ".css", ".vue", ".json"],
        /**
         * @description 定义路径的映射
         * @date 2018-07-31
         */
        alias: {
            ...
            "@share": path.resolve(__dirname, "../../hdbx_share"),
            "@utils": path.resolve(__dirname, "../../hdbx_share/js/utils"),
